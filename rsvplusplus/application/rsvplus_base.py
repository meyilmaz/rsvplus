...
def show_user_form():
    ...
    cur = db.execute('select title, text from entries order by id desc')
    entries = cur.fetchall()
    return render_template('user_form.html', entries=entries)
...
def show_org_form():
    ...
    cur = db.execute('select title, text from entries order by id desc')
    entries = cur.fetchall()
    return render_template('org_form.html', entries=entries)
...
def show_event_form():
    ...
    cur = db.execute('select title, text from entries order by id desc')
    entries = cur.fetchall()
    return render_template('event_form.html', entries=entries)
